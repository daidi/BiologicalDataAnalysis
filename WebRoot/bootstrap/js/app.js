...
var App = function() {
	...
	var handleSidebarMenu = function() {
		...
		jQuery('.page-sidebar').on('click', ' li > a.ajaxify', function(e) {
					...
					$.post(url, {}, function(res) {
								...
								App.initUniform(); // initialize uniform
													// elements
							});
				});
	}
	...
	var handlePortletTools = function() {
		...
		jQuery('body').on('click',
				...
				function(e) {
					e.preventDefault();
					var el = jQuery(this).closest(".portlet")
	...
	var handleFixInputPlaceholderForIE = function() {
		...
		if (isIE8 || isIE9) { // ie7&ie8
			...
			// password fields)
			jQuery('input[placeholder]:not(.placeholder-no-fix), textarea[placeholder]:not(.placeholder-no-fix)')
					.each(function() {
